...
--[[
  ...
  -Ensure that you have the btmap_notifications.xml, btmap_notifications.js, and btmap_notifications.css files in your panorama content folder.
  -Ensure that btmap_notifications.xml is included in your custom_ui_manifest.xml with
    <CustomUIElement type="Hud" layoutfile="file://{resources}/layout/custom_game/btmap_notifications.xml" />
