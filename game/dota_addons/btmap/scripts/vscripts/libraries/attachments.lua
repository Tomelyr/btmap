...
--[[
  ...
  -Ensure that you have the btmap_attachments.xml, btmap_attachments.js, and btmap_attachments.css files in your panorama content folder to use the GUI.
  -Ensure that btmap_attachments.xml is included in your custom_ui_manifest.xml with
    <CustomUIElement type="Hud" layoutfile="file://{resources}/layout/custom_game/btmap_attachments.xml" />
