...
--[[
  ...
  See BTMap:PostLoadPrecache() in btmap.lua for more information
  ]]

  DebugPrint("[BTMAP] Performing pre-load precache")
...
function Activate()
  GameRules.BTMap = BTMap()
  GameRules.BTMap:_InitBTMap()
end
